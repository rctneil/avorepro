...
class ModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create model" do
    assert_difference("Model.count") do
      post models_url, params: { model: { company_id: @model.company_id, name: @model.name } }
    end
  ...
  test "should update model" do
    patch model_url(@model), params: { model: { company_id: @model.company_id, name: @model.name } }
